...
<div class="working-form">
    ...
    <div class="col-md-12"><?= $form->field($model, 'company')->textInput(['maxlength' => true]) ?></div>

    <div class="col-md-12"><?= $form->field($model, 'type')->textInput(['maxlength' => true]) ?></div>
  ...
  <div class="col-md-12">  <?= $form->field($model, 'description')->textarea(['rows' => 6]) ?></div>
   ...
   'clientOptions' => [
    ...
    <div class="col-md-12">   <?= $form->field($model, 'salary')->textInput(['maxlength' => true]) ?></div>
